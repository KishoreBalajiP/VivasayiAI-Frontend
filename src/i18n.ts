...
allDeleted: 'All chats cleared successfully!',
      ...
      unsupportedImage: 'Unsupported image. Please attach a JPG, PNG or WEBP image (up to 5 MB).',
...
micError: 'மைக்ரோஃபோன் பிழை',
      ...
      imageUploadFailed: 'படம் பதிவேற்றம் தோல்வியடைந்தது. மீண்டும் முயற்சிக்கவும்.',
      ...
      unsupportedImage: 'ஆதரிக்கப்படாத படம். JPG, PNG அல்லது WEBP படத்தை (அதிகபட்சம் 5 MB) இணைக்கவும்.',
