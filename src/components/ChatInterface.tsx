      ...
      <header className="bg-green-600 text-white px-3 py-2 shadow-lg">
        <div className="flex items-center justify-between max-w-4xl mx-auto">
          ...
          <div className="flex items-center gap-2 overflow-hidden">
            <div className="flex-shrink-0 w-9 h-9 sm:w-11 sm:h-11 bg-white rounded-full flex items-center justify-center">
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              onClick={logout}
              className="hidden sm:flex p-2 hover:bg-green-700 rounded-lg"
            >
